...
<head>
    ...
    <title>Processando Mensagens</title>
...
<body>
    <!-- Título da página -->
     ...
     <p>
        <?php
            // Verifica se o campo "mensagem foi enviado atraves do fimulario
            if(isset($_POST['mensagem'])){
                // A função htmlspecialchars impede que o usuario envie códigos perigosos (como scripts).
